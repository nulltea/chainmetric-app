...
class GeoService {
  ...
  static final eastCoordinateUUID =
      Uuid.parse("00002ab1-0000-1000-8000-00805f9b34fb");

  static final northCoordinateUUID =
      Uuid.parse("00002ab0-0000-1000-8000-00805f9b34fb");

  static final locationNameUUID =
      Uuid.parse("00002ab5-0000-1000-8000-00805f9b34fb");
  ...
  static Future<void> postLocation(String deviceID) async {
    ...
    if (!Bluetooth.isConnected(deviceID)) {
      if (await DevicesController.sendCommand(
          deviceID, DeviceCommand.pairBluetooth)) {
    ...
    final latitudePayload = Uint8List(8)
      ..buffer.asByteData().setFloat64(0, position.latitude);
    final longitudePayload = Uint8List(8)
      ..buffer.asByteData().setFloat64(0, position.longitude);

    await Bluetooth.driver.writeCharacteristicWithoutResponse(
        eastCoordinateChar,
        value: latitudePayload.toList());

    await Bluetooth.driver.writeCharacteristicWithoutResponse(
        northCoordinateChar,
        value: longitudePayload.toList());
    ...
    await Bluetooth.driver.writeCharacteristicWithoutResponse(locationNameChar,
        value: locationNamePayload);
  }
